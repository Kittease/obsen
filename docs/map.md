...
Found by query, not listed here — open tickets in `docs/tickets/` with all blockers closed and no assignee. All research, prototype, engine-design, and licensing tickets are resolved. [025 adopt SecretStorage?](tickets/025-adopt-secretstorage-for-credentials.md) is the frontier; [022 settings/onboarding UX](tickets/022-design-settings-onboarding-ux.md) waits on 025; then only [023 the spec itself](tickets/023-write-v1-spec.md) remains.
